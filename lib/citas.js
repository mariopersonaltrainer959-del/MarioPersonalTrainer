...
/** Fecha YYYY-MM-DD estable (Postgres DATE, ISO string o Date) */
...
async function list(negocioId, { startDate, endDate, pacienteId } = {}) {
  ...
  return rows.map((c) => ({
    ...
    hora_inicio: normalizeHora(c.hora_inicio),
    hora_fin: normalizeHora(c.hora_fin)
  }));
}
